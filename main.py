...
class App(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.year_combobox = ttk.Combobox(self.date_frame, values=list(range(2023, 2030)), width=5, state="readonly")
        ...
        self.month_combobox = ttk.Combobox(self.date_frame, values=list(range(1, 13)), width=3, state="readonly")
        ...
        self.day_combobox = ttk.Combobox(self.date_frame, values=list(range(1, 32)), width=3, state="readonly")
        ...
        self.end_year_combobox = ttk.Combobox(self.enddate_frame, values=list(range(2023, 2030)), width=5, state="readonly")
        ...
        self.end_month_combobox = ttk.Combobox(self.enddate_frame, values=list(range(1, 13)), width=3, state="readonly")
        ...
        self.end_day_combobox = ttk.Combobox(self.enddate_frame, values=list(range(1, 32)), width=3, state="readonly")
    ...
    def start_resv(self):
        ...
        t = Thread(target=scan, args=(selected_devId, selected_start_date, selected_end_date, self.cookie_entry.get(), self.result_listbox))
        t.start()
